...
if arg_configs["model"][0]:
    ...
    NORMALIZATION = "Normalized_" if arg_configs["normalization"] else ""
    ...
    MEMO = (
        NORMALIZATION
        + f"Standardized_{arg_configs['model'][0]}_{arg_configs['criterion'][0]}_{LR_NAME}"
    )

else:
    TIMESTAMP = datetime.now().strftime("%Y%m%d_%H%M%S")
    TESTNAME = "Takase"
    MEMO = f"Standardized_SelfMadeModel_LRe-5~4"
...
normalization_param = {
    "Aoki": [16.592, 1000.0],
    "Kinugasa": [18.056, 1000.0],
    "Masuda": [16.592, 1000.0],
    "Takase": [18.056, 249.856],
    "Teragiwa": [14.152, 1000.0],
    "Soma": [18.056, 1000.0],
    "Yatsuda": [16.592, 1000.0],
}
        ...
        for i, config in enumerate(configs):
            for valname in [
                ...
                if NORMALIZATION:
                    ...
                    dataset.set_normalization_param(normalization_param)
